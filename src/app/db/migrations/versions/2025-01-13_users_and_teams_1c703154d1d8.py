...
from advanced_alchemy.types import DateTimeUTC, EncryptedString, EncryptedText, GUID, ORA_JSONB
...
def schema_upgrades() -> None:
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTimeUTC(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
            ["user_id"], ["user_account.id"], name=op.f("fk_user_account_oauth_user_id_user_account"), ondelete="cascade"
        ),
