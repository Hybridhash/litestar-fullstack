...
class UserController(Controller):
    ...
    async def create_user(
        ...
        request: HTMXRequest,
        users_service: UserService,
        data: Annotated[UserCreate, Body(title="Create User", media_type=RequestEncodingType.URL_ENCODED)],
    ) -> User | HTMXTemplate:
        """Create a new user."""
    ...
    @delete(operation_id="DeleteUser", path=urls.ACCOUNT_DELETE, status_code=HTTP_200_OK)
